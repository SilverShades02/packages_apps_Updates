...
import com.strange.ota.UpdaterApplication;
import com.strange.ota.activities.UpdaterActivity;
import com.strange.ota.misc.Constants;
import com.strange.ota.misc.State;
import com.strange.ota.misc.UpdateInfo;
import com.strange.ota.requests.UpdatesJsonObjectRequest;
import com.strange.ota.service.UpdateCheckService;
...
public class UpdateChecker implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    // broadcast actions
    public static final String ACTION_CHECK_FINISHED = "com.strange.ota.action.UPDATE_CHECK_FINISHED";
