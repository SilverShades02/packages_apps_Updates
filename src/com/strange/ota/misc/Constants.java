 ...
 */
package com.strange.ota.misc;

import android.app.AlarmManager;

public class Constants {
    // Download related
    public static final String UPDATES_FOLDER = "STRANGE-Updates";
    public static final String DOWNLOAD_ID = "download_id";
    public static final String DOWNLOAD_NAME = "download_name";
    public static final String DOWNLOAD_TMP_EXT = ".tmp";
    public static final String DOWNLOAD_CHANNEL_ID = "com.strange.ota.DOWNLOAD_CHANNEL";
    public static final String DOWNLOADING_CHANNEL_ID = "com.strange.ota.DOWNLOADING_CHANNEL";
    // Preferences
    ...
    // Build vars
    public static final String CURRENT_DEVICE_NAME = "ro.aoscp.device";
    public static final String CURRENT_VERSION = "ro.aoscp.version";
    public static final String CURRENT_BUILD_TYPE = "ro.aoscp.releasetype";
    public static final String OTA_URL = "https://raw.githubusercontent.com/StrangeNoob/STRANGE-Updates/9.x/%s";
    // Expressions
